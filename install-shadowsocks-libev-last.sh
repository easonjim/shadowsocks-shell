#!/usr/bin/env bash
# 
# install shadowsocks-libev last version
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/easonjim/centos-shell/master/shadowsocks/service-script.sh"
}
...
pre_install(){
    ...
    read -p "(Default password: 1234561):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="1234561"
    echo
    echo "---------------------------"
