...
get_latest_version(){
    echo -e "[${green}Info${plain}] Start get shadowsocks-libev latest version..."
    echo
...
config_server_file_default(){
    shadowsocksport=$2
    [ -z "$2" ] && shadowsocksport=16028
    shadowsockspwd=$3
    [ -z "$3" ] && shadowsockspwd="P@ssw0rd1234561"
    shadowsockscipher=$4
    [ -z "$4" ] && shadowsockscipher="aes-192-cfb"
...
config_local_file(){
    ...
    read -p "(Default local port: ${lport}):" shadowsockslocalport
    [ -z "${shadowsockslocalport}" ] && shadowsockslocalport=${lport}
    echo
    echo "---------------------------"
    echo "local port = ${shadowsockslocalport}"
    echo "---------------------------"
    echo
...
# $1-config file name $2-shadowsocksip $3-shadowsocksport $4-shadowsockspwd $5-shadowsockscipher $5-shadowsockslocalport
config_local_file_default(){
    ...
    shadowsockslocalport=$6
    [ -z "$6" ] && shadowsockslocalport="1080"
...
# $1-config file name $2-service name $3-shadowsocksport $4-shadowsockspwd $5-shadowsockscipher $6-shadowsockslocalport
install_shadowsocks_libev_and_config_server_auto(){
    config_server_file_default $1 $3 $4 $5 $6
    disable_selinux 
    pre_install
    download_files
    install_shadowsocks
...
# $1-config name $2-service name $3-daemon name $4-shadowsocksip $5-shadowsocksport $6-shadowsockspwd $7-shadowsockscipher $8-shadowsocklocalport
install_shadowsocks_libev_and_config_local_auto(){
    config_local_file_default $1 $4 $5 $6 $7 $8
    disable_selinux 
    pre_install
    download_files
    install_shadowsocks
...
print_use_help(){
    ...
    echo -e "   -arg:[--config_name]    : \033[41;37m       config name,default is ss-server \033[0m"
    echo -e "   -arg:[--service_name]   : \033[41;37m       service name,default is ss-server \033[0m"
    ...
    echo -e "   -arg:[--config_name]    : \033[41;37m       config name,default is ss-local \033[0m"
    echo -e "   -arg:[--service_name]   : \033[41;37m       service name,default is ss-local \033[0m"
    echo -e "   -arg:[--daemon_name]    : \033[41;37m       daemon name,default is ss-local \033[0m"
    echo -e "install_local_auto         : \033[41;37m install shadowsocks-libev and auto config local \033[0m"
    echo -e "   -arg:[--config_name]    : \033[41;37m       config name,default is ss-local \033[0m"
    echo -e "   -arg:[--service_name]   : \033[41;37m       service name,default is ss-local \033[0m"
    echo -e "   -arg:[--daemon_name]    : \033[41;37m       daemon name,default is ss-local \033[0m"
    echo -e "   -arg:[--server_ip]      : \033[41;37m       server ip,default is 8.8.8.8 \033[0m"
    echo -e "   -arg:[--port]           : \033[41;37m       port,default is 16028 \033[0m"
    echo -e "   -arg:[--password]       : \033[41;37m       password,default is P@ssw0rd1234561 \033[0m"
    echo -e "   -arg:[--cipher]         : \033[41;37m       cipher,default is aes-192-cfb \033[0m"
    echo -e "   -arg:[--local_port]     : \033[41;37m       local port,default is 1080 \033[0m"
